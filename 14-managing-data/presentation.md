...
&shy;<!-- .element class="fragment fade-in-with-next" -->To **automate data migration**, begin by **versioning your database**. Create a **version table** and generate **two scripts** for each change:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->**No** issues if your rollback scripts meet these criteria:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->When rolling back involves the following, **just running the scripts is not enough**:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->Solutions:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->A third approach for managing hot deployments is that you **don't** have to **migrate your database with every app release**:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->This section will address **two concerns**:
- Test performance
...
&shy;<!-- .element class="fragment fade-in-with-next" -->In unit tests, **replace services that talk to databases with test doubles**. If not possible (e.g., for testing these services):
...
&shy;<!-- .element class="fragment fade-in-with-next" -->Three **test state management** approaches:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->Test isolation ensures tests are **atomic**, **independent**, and **not influenced by the others** [success/failure]. This can be achieved by:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->There's a temptation to create a **"story" for tests** to **maintain coherent data**, **reducing setup and teardown**:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->But, it **tightly couples tests** due to the desire for a coherent story:
...
&shy;<!-- .element class="fragment fade-in-with-next" -->We commonly isolate code for **creating test data instances** and **share them across multiple test cases**:
